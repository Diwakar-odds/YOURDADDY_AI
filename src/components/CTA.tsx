...
export default function CTA() {
  return (
    <section className="relative py-24 bg-gradient-to-b from-[#1F2937] to-[#374151] overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-[#38BDF8] to-[#7DD3FC] text-white font-bold text-lg rounded-xl overflow-hidden shadow-lg shadow-[#38BDF8]/50 mb-8"
          >
        ...
        >
          {[
            ...
            <div key={index} className="bg-[#374151]/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
              <div className="text-2xl font-bold bg-gradient-to-r from-[#38BDF8] to-[#7DD3FC] text-transparent bg-clip-text mb-2">
                {item.title}
              </div>
